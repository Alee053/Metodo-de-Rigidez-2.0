...
export default function SingleBarCerchas({bar = new Bar(), id}) {
  ...
  const applyChanges = () => {
    ...
    newBars[id] = {lx: bar.lx, ly: bar.ly, A: bar.A, E: bar.E, L: bar.L, num: bar.num};
  ...
  return (
    <div
      className='bg-white justify-items-center bg-opacity-10 border-2 rounded-2xl p-5 pl-10 pb-0 grid grid-rows-2 place-items-center justify-self-center self-start relative w-max'>
